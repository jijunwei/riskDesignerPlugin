...
/*    */     }
/* 56 */     workItemNode.getWork().setParameter("MessageId", message.getId());
/* 57 */     workItemNode.getWork().setParameter("MessageType", message.getType());
/*    */   }
/*    */ 
/*    */   protected String getTaskName(Element element) {
/* 61 */     return "Receive Task";
/*    */   }
/*    */ 
/*    */   public void writeNode(Node node, StringBuilder xmlDump, boolean includeMeta) {
/* 65 */     throw new IllegalArgumentException("Writing out should be handled by WorkItemNodeHandler");
/*    */   }
/*    */ }

/* Location:           D:\soft\eclipse-jee-mars-R-win32-x86_64\eclipse\configuration\org.eclipse.osgi\1104\0\.cp\lib\jbpm-bpmn2.jar
 * Qualified Name:     org.jbpm.bpmn2.xml.ReceiveTaskHandler
