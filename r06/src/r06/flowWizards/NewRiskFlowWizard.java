...
public class NewRiskFlowWizard extends Wizard implements INewWizard {
	private NewRiskFlowWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for SampleNewWizard.
	 */
	public NewRiskFlowWizard() {
		super();
	...
	public void addPages() {
		page = new NewRiskFlowWizardPage(selection);
		addPage(page);
	}
