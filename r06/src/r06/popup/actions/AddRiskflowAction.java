...
public class AddRiskflowAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		IWizardDescriptor wizardDesc = WorkbenchPlugin.getDefault()
				.getNewWizardRegistry().findWizard("r06.flowWizards.NewRiskFlowWizard"); 
		if (wizardDesc != null) {
