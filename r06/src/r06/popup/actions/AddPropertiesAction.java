...
public class AddPropertiesAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		IWizardDescriptor wizardDesc = WorkbenchPlugin.getDefault()
				.getNewWizardRegistry().findWizard("r06.propertiesWizards.NewPropertiesWizard"); 
		if (wizardDesc != null) {
