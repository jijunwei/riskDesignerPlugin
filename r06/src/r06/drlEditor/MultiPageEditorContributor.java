...
public class MultiPageEditorContributor extends TextEditorActionContributor {
	...
	private void createActions() {
		sampleAction = new Action() {
			public void run() {
				MessageDialog.openInformation(null, "drlEditor", "drlEditor Test Action Executed");
			}
		};
		sampleAction.setText("drlEditorTest Action");
		sampleAction.setToolTipText("drlEditor Test Action tool tip");
		sampleAction.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().
				getImageDescriptor(IDE.SharedImages.IMG_OBJS_TASK_TSK));
	}
	public void contributeToMenu(IMenuManager manager) {
		IMenuManager menu = new MenuManager("drlEditor Editor &Menu");
